...
# # Set the resolution to half the width and height
# cap.set(cv.CAP_PROP_FRAME_WIDTH, int(cap.get(cv.CAP_PROP_FRAME_WIDTH)/2))
# cap.set(cv.CAP_PROP_FRAME_HEIGHT, int(cap.get(cv.CAP_PROP_FRAME_HEIGHT)/2))
...
#     cv.putText(gray, f'FPS: {fps}', (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
